              ...
              children: [
                ...
                Column(
                  children: [
                    //------------user mail
                    EmailField(
                      textController: _controller.emailReg,
                    ...
                    //--------------------password
                    PasswordField(
                      textController: _controller.passwordReg,
                      hint: "Password",
                ...
                Column(
                  children: [
                    ...
                    MajorButton(
                      text: "Sign up",
                      onTap: () async {
                        Logger().i("Email---${_controller.emailReg.text}");
                        Logger().i("Email---${_controller.passwordReg.text}");
